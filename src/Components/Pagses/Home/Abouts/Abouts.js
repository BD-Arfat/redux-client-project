        ...
        <div>
            ...
            <div className="hero md:mt-28">
                <div className="hero-content flex-col lg:flex-row">
                    <img src={aboutImage} alt='' className=" w-96 md:w-1/2 rounded-lg shadow-2xl" />
                    <div className='md:w-1/2 w-96 md:ms-3'>
                        ...
                        <button className="btn btn-neutral w-96 md:w-44">Get Started</button>
                    </div>
                </div>
            </div>
        </div>
